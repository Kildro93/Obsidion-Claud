...
- [ ] Firebase-API-Key in der Google Cloud Console auf erlaubte Domains beschraenken (Mensch, 5 Min) — siehe [[SETUP-FIREBASE]], Abschnitt 4
- [ ] Keystore-Backup ausser Haus ablegen — siehe [[BACKUP-STRATEGY]], Ebene 3
