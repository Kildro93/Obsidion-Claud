...
Voraussetzung: GitHub-Token liegt im Credential Manager, siehe [[MEMORY/setup/setup-github-token]].
...
|---|---|---|
| `PUSH FEHLGESCHLAGEN (Exit 128)` | Token abgelaufen | [[MEMORY/setup/setup-github-token]], Abschnitt "Token erneuern" |
